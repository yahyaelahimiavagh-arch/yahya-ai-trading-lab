...
قدم جاری: **P4-002 MERGED — P4-003 IMPLEMENTED, RUNTIME PENDING**
...
notional و exposure را روی شاخه مستقل پیاده‌سازی کرده و runtime آن در انتظار است.
...
| checkpointهای P4 | 2 از 10 | 8 checkpoint | P4-001 و P4-002 روی `main`؛ P4-003 هنوز پذیرفته نشده |
...
1. تکمیل P4-003 تا P4-010: exposure، state، protective gate،
...
P4-002 در checkpoint `bc2bd30` merge شد. P4-003 اکنون روی شاخه مستقل در حال اجراست.
