...
و اکنون منتظر شواهد GitHub Actions است.
...
| checkpointهای P4 | 6 از 10 | 4 checkpoint | P4-001 تا P4-006 روی `main`؛ P4-007 پیاده‌سازی شده ولی runtime هنوز پذیرفته نیست |
...
1. پذیرش runtime P4-007 و تکمیل P4-008 تا P4-010: adapter، سناریوهای adversarial
   و ممیزی نهایی.
...
reset دستی همراه شواهد clear جدید پیاده‌سازی شده است. ۱۳ تست متمرکز، ۸۲ تست P4 و
کل **365/365** تست محلی پاس شده‌اند؛ پذیرش runtime GitHub Actions هنوز در انتظار
است و P4-008 شروع نشده است.
