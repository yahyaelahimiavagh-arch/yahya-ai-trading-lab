...
قدم جاری: **P4-009 IMPLEMENTED — GITHUB RUNTIME PENDING**
...
| P4 Risk Manager | اندازه موقعیت، محدودیت ریسک و Kill Switch مستقل | **در حال اجرا؛ P4-008 merge شده، P4-009 در حال اعتبارسنجی** |
...
ماتریس adversarial را پیاده‌سازی کرده و runtime GitHub آن هنوز در انتظار است.
...
| checkpointهای P4 | 8 از 10 | 2 checkpoint | P4-001 تا P4-008 روی `main`؛ P4-009 فقط محلی سبز است و هنوز runtime پذیرفته نشده |
...
1. پذیرش runtime P4-009 و تکمیل P4-010: ممیزی مستقل نهایی Risk Manager.
...
byte-compare پیاده‌سازی کرده است. 11 تست scenario، 109 تست متمرکز P4 و کل
**392/392** تست محلی سبز هستند؛ runtime GitHub هنوز در انتظار است و checkpointهای
پذیرفته‌شده P4 تا آن زمان همان 8 از 10 باقی می‌ماند.
