...
pre/post-entry portfolio state and entry fill required to seed the separate
CRL-006 synthetic open-position shock matrix. Historical and synthetic outcomes
remain separate.
